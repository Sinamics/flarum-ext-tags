...
export default class TagSettingsModal extends SettingsModal {
  ...
  form() {
    const minPrimaryTags = this.setting('sinamics-tags.min_primary_tags', 0);
    const maxPrimaryTags = this.setting('sinamics-tags.max_primary_tags', 0);

    const minSecondaryTags = this.setting('sinamics-tags.min_secondary_tags', 0);
    const maxSecondaryTags = this.setting('sinamics-tags.max_secondary_tags', 0);

    return [
      <div className="Form-group">
        <label>{app.translator.trans('sinamics-tags.admin.tag_settings.required_primary_heading')}</label>
      ...
      <div className="Form-group">
        <label>{app.translator.trans('sinamics-tags.admin.tag_settings.required_secondary_heading')}</label>
        <div className="helpText">
